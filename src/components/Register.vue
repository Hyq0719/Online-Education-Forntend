...
export default {
  ...
  data() {
    ...
    return {
      apiUrl: this.Api + '/api/Student/addStudent',
      ruleForm: {
        name: '',
        pass: '',
        checkPass: '',
  ...
  methods: {
    StudentRegister() {
      ...
      let that = this;
      axios.post(this.Api + '/api/Student/addStudent', a, {headers: {'Content-Type': 'application/x-www-form-urlencoded'}}).then(function (response) {
